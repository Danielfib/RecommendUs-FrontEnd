...
class Preference2 extends React.Component {
      ...
      tags: [
        {
          name: "Açaí",
          image:
            "https://img.stpu.com.br/?img=https://s3.amazonaws.com/pu-mgr/default/a0RG000000sOHSbMAO/5820cf6de4b0c8177ff320fc.jpg&w=620&h=400"
        },
        {
          name: "Contemporânea",
          image:
            "http://saopauloparainiciantes.com.br/wp-content/uploads/images//DSC03161-575x431.jpg"
        },
        {
          name: "Brasileira",
          image:
            "http://159.203.100.140/wp-content/uploads/2017/05/image7-1024x682.jpg"
        },
        {
          name: "Café",
          image:
            "https://images.pexels.com/photos/296888/pexels-photo-296888.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
        }
      ],
      choices: []
    };
  ...
  sendInfo() {
    ...
    axios
      .post(`${requests.getUrl()}/groups/fill-preferences`, data)
      .then(res => {
  ...
  selectOption = name => {
    ...
    if (idx > -1) this.state.choices.splice(idx, 1);
    else this.state.choices.push(name);
  };
    ...
    return (
      <View style={styles.container}>
        ...
        <Header navigation={this.props.navigation}>
          <Text style={styles.titleHeader}>{"Preferências"}</Text>
        </Header>
        <ScrollView>
          <View style={styles.subContainer}>
            ...
            <View style={styles.choices}>
              <View style={[styles.choice, { flex: 2 }]}>
                <Text style={styles.title}>{"O que você quer comer?"}</Text>
