...
export default class Preferences extends React.Component {
  ...
  createGroup() {
    if (this.props.navigation.state.params.skipCalendar) {
      ...
      axios
        .post(`${requests.getUrl()}/create-group`, data)
        .then(res => {
    ...
    return (
      <View style={style.mainContainer}>
        ...
        <Header navigation={this.props.navigation}>
          <Text style={style.titleHeader}>{"Preferências"}</Text>
        </Header>
          ...
          <ScrollView>
            {this.state.friends && (
              <View style={style.friendsView}>
                ...
                <Text style={style.friendsText}>{"Esperando Confirmação"}</Text>
            ...
            <View style={[{ marginTop: em(4) }]}>
              ...
              <View style={[style.containerSlider]}>
                <MultisliderButton
                  ...
                  callback={this.getMultisliderReponse.bind(this)}
                />
            ...
            {!this.props.navigation.state.params.skipCalendar && (
              <View style={style.container}>
                <View style={style.titleAndButton}>
                  ...
                  <TouchableOpacity
                    style={[
                      style.buttonBestDays,
                      this.state.pressed ? { backgroundColor: "#A30000" } : {}
                    ]}
            ...
            <View style={[style.container, { marginBottom: em(28) }]}>
              ...
              <View style={style.pickerContainer}>
                <PickerButton
                  gpsButton={true}
                  dimensions={{ height: em(6.5), width: em(80) }}
                  defaultOption={this.state.pickerValue}
                  data={["Recife", "Olinda", "Jaboatão"]}
